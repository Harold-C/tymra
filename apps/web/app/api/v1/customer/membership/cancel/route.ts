...
import { BillingError, cancelMembershipAtPeriodEnd } from "@/lib/server/membership/stripe-billing";
...
export async function POST(request: NextRequest) {
  try {
    ...
    return apiSuccess(await cancelMembershipAtPeriodEnd(session.customerUserId));
  } catch (error) {
