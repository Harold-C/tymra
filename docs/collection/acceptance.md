...
本地验收用于证明真实传输、解析、持久化、幂等和安全控制在一个有边界的开发运行中可用。它不等同于生产启用、全国完整性、生产容量或多日无人值守稳定性验收。2026-07-21 的完整执行记录保存在[本地采集验收快照](../evidence/collection-acceptance-2026-07-21.md)。
