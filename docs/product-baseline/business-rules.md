...
一次可比较住宿查询。最少包含：入住日、退房日、晚数、成人数、儿童数、单位数、货币、取消条件类别和当地时区。
...
真实价格检查只支持新西兰房源。用户所在地不影响资格；资格由 Property 所在国家决定。默认货币 NZD，金额显示 NZ$，日期和时区使用房源当地时间。
...
2 名成人、1 个单位、未来 30 天、默认 1 晚、当地时区。若目标 Unit 或可比市场存在普遍最短住宿限制，使用可比较的共同住宿长度并记录原因。
